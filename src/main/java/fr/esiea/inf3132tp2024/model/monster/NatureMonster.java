...
public class NatureMonster extends Monster {
     ...
     * @param attacks
     */
    public NatureMonster(String name, int health, int attack, int speed, int defense, SpecialAttack specialAttack, float specialCapacityChance, Attack[] attacks) throws MonsterTooManyAttacks {
        super(Types.NATURE, name, health, attack, speed, defense, specialAttack, specialCapacityChance, attacks);
    }
